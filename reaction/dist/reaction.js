...
React.render(
    React.createElement(Autocomplete, {items: people, findMethod: find }),
    document.getElementById( 'container' )
);

},{"../samples/people.json":149,"./autocomplete.react.jsx":150,"react":148}],2:[function(require,module,exports){
  ...
  render : function()
  {
    return (
      React.createElement("div", {className: "autocomplete"}, 
        React.createElement("input", {onKeyUp:  this.onKeyUp, className: ""}), 
        React.createElement(AutocompleteList, {items: this.state.found})
      )
    );
  }
...
},{"./autocompletelist.react.jsx":151,"react":148}],151:[function(require,module,exports){
'use strict';

var React = require('react');

var AutocompleteList = React.createClass({displayName: 'AutocompleteList',
